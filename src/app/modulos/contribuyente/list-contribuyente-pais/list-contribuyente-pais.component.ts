...
@Component({
  selector: 'app-list-contribuyente-pais',
  templateUrl: './list-contribuyente-pais.component.html',
  styleUrls: ['./list-contribuyente-pais.component.css']
})
export class ListContribuyentePaisComponent implements OnInit {
  public pais: string;
