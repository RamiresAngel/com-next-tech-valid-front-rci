...
@Component({
  selector: 'app-list-centro-costos-pais',
  templateUrl: './list-centro-costos-pais.component.html',
  styleUrls: ['./list-centro-costos-pais.component.css']
})
export class ListCentroCostosPaisComponent implements OnInit {
