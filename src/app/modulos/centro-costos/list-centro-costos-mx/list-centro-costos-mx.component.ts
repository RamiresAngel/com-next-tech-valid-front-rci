...
@Component({
  selector: 'app-list-centro-costos-mx',
  templateUrl: './list-centro-costos-mx.component.html',
  styleUrls: ['./list-centro-costos-mx.component.css']
})
export class ListCentroCostosMxComponent implements OnInit {
  public opcionesDt = {
    ordering: false,
    dom: 'lBfrtip',
    scrollX: true,
  ...
  ActualizaLista(identificador_corporativo: any = null) {
    ...
    $('#tabla_sucursales').DataTable().destroy();
    this._servicio_centro_costos.ObtenerListaCentroCostosMXPorCorporativo(
      ...
      , () => {
        setTimeout(() => {
          $('#tabla_sucursales').DataTable(this.opcionesDt);
        }, 1000);
      }
    );
  }
