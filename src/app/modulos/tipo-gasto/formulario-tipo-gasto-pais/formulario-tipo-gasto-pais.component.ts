...
@Component({
  selector: 'app-formulario-tipo-gasto-pais',
  templateUrl: './formulario-tipo-gasto-pais.component.html',
  styleUrls: ['./formulario-tipo-gasto-pais.component.css']
})
export class FormularioTipoGastoPaisComponent implements OnInit {
