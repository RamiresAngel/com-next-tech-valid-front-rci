...
@Component({
  selector: 'app-list-acreedores-diversos-mx',
  templateUrl: './list-acreedores-diversos-mx.component.html',
  styleUrls: ['./list-acreedores-diversos-mx.component.css']
})
export class ListAcreedoresDiversosMxComponent implements OnInit {
