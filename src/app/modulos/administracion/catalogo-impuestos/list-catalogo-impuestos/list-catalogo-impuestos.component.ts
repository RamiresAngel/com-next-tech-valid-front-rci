...
@Component({
  selector: 'app-list-catalogo-impuestos',
  templateUrl: './list-catalogo-impuestos.component.html',
  styleUrls: ['./list-catalogo-impuestos.component.css']
})
export class ListCatalogoImpuestosComponent implements OnInit {

  lista = new Array<Impuesto>();
  public opcionesDt = {
    ordering: false,
    dom: 'lBfrtip',
    scrollX: true,
  ...
  constructor(
    ...
    private catalogoService: CatalogoImpuestosService,
  ...
  obtenerDatos() {
    $('#tabla_impuestos').DataTable().destroy();
    this.catalogoService.obtenerImpuestos(this.identificador_corporativo).subscribe((data: Array<Impuesto>) => {
      this.lista = data;
      setTimeout(() => {
  ...
  editar(id) {
    ...
    this.router.navigate(['/home/catalogo_impuestos/edit', id_encriptado]);
  }
