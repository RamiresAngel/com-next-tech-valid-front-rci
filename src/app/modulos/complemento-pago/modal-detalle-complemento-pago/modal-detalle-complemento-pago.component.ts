...
@Component({
  selector: 'app-modal-detalle-complemento-pago',
  templateUrl: './modal-detalle-complemento-pago.component.html',
  styleUrls: ['./modal-detalle-complemento-pago.component.css']
})
export class ModalDetalleComplementoPagoComponent implements OnInit {
  @Input() data: any;
  @Input() id_Doc: string;
  ...
  cerrarModal() {
    ...
    $('#modal-detalle-complemento-pago').modal('hide');
  }
