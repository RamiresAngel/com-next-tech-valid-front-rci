...
import { FiltroAmortizadores, FlujoAprobacion, CorporativoActivo, Usuario, DatosIniciales, DetalleAmortizacion, DataTablesResponse, AccionAprobar } from 'src/app/entidades';
...
declare var $: any;
@Component({
  selector: 'app-lista-amortizacion-rd',
  templateUrl: './lista-amortizacion-rd.component.html',
  styleUrls: ['./lista-amortizacion-rd.component.css']
})
export class ListaAmortizacionRdComponent implements OnInit {
      ...
      , ajax: (dataTablesParameters: any, callback) => {
        that.http
          .post<DataTablesResponse>(
            ...
            if (this.filtroConsulta.contributente_identificador !== '' && this.filtroConsulta.identificador_corporativo !== '' && this.filtroConsulta.sucursal_identificador !== '') {
              console.log(resp);
