...
@Component({
  selector: 'app-list-comprobaciones-mx',
  templateUrl: './list-comprobaciones-mx.component.html',
  styleUrls: ['./list-comprobaciones-mx.component.css']
})
export class ListComprobacionesMxComponent implements OnInit {
