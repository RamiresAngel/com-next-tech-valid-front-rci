...
@Component({
  selector: 'app-filtro-comprobacion',
  templateUrl: './filtro-comprobacion.component.html',
  styleUrls: ['./filtro-comprobacion.component.css']
})
export class FiltroComprobacionComponent implements OnInit {
  ...
  buscar() {
    ...
    this.enviarData.emit(this.filtro_comprobacion.value);
  }
