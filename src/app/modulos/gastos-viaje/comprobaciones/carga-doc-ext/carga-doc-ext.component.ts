...
@Component({
  selector: 'app-carga-doc-ext',
  templateUrl: './carga-doc-ext.component.html',
  styleUrls: ['./carga-doc-ext.component.css']
})
export class CargaDocExtComponent implements OnInit {
