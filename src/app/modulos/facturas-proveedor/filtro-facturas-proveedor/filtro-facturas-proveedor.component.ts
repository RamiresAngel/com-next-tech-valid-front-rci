...
@Component({
  selector: 'app-filtro-facturas-proveedor',
  templateUrl: './filtro-facturas-proveedor.component.html',
  styleUrls: ['./filtro-facturas-proveedor.component.css']
})
export class FiltroFacturasProveedorComponent implements OnInit {
