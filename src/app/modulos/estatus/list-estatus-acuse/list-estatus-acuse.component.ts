...
@Component({
  selector: 'app-list-estatus-acuse',
  templateUrl: './list-estatus-acuse.component.html'
})
export class ListEstatusAcuseComponent implements OnInit {
  ...
  public updateList() {
    this._servicio.getEstatusAcuse()
