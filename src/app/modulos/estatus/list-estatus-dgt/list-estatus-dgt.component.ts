...
declare var $: any;
@Component({
  selector: 'app-list-estatus-dgt',
  templateUrl: './list-estatus-dgt.component.html'
})
export class ListEstatusDgtComponent implements OnInit {
  ...
  public updateList() {
    this._servicio.getEstatusFiscal()
