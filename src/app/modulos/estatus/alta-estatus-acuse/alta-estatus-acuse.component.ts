...
@Component({
  selector: 'app-alta-estatus-acuse',
  templateUrl: './alta-estatus-acuse.component.html'
})
export class AltaEstatusAcuseComponent implements OnInit {
  ...
  public add() {
    ...
    if (this.form.valid) {
      ...
      this._servicio.addEstatusAcuse(this.estatus)
        .subscribe(
          result => {
          },
          err => {
