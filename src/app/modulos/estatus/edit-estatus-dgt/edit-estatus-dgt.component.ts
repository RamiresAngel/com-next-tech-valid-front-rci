...
@Component({
  selector: 'app-edit-estatus-dgt',
  templateUrl: './edit-estatus-dgt.component.html',
})
export class EditEstatusDgtComponent implements OnInit {
  ...
  public getId(id) {
    this._servicio.getEstatusFiscalId(id)
  ...
  public update() {
    if (this.form.valid) {
      ...
      this._servicio.updateEstatusFiscal(this.estatu[0])
        .subscribe(
          result => {
          },
          err => {
