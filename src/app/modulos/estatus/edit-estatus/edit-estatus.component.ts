...
@Component({
  selector: 'app-edit-estatus',
  templateUrl: './edit-estatus.component.html'
})
export class EditEstatusComponent implements OnInit {
  ...
  public getId(id) {
    this._servicio.getEstatusPortalId(id)
  ...
  public update() {
    if (this.form.valid) {
      ...
      this._servicio.updateEstatusPortal(this.estatu[0])
        .subscribe(
          result => {
          },
          err => {
