...
@Component({
  selector: 'app-lista-parametros-sistema-rci',
  templateUrl: './lista-parametros-sistema-rci.component.html',
  styleUrls: ['./lista-parametros-sistema-rci.component.css']
})
export class ListaParametrosSistemaRciComponent implements OnInit {
  ...
  ActualizaLista() {
    ...
    this.servicio_parametros.ObtenerListaParametrosSistemaMXPorCorporativo(this.identificador_corporativo)
      .subscribe(
        (data: any) => {
