...
@Component({
  selector: 'app-lista-parametros-sistema-pais',
  templateUrl: './lista-parametros-sistema-pais.component.html',
  styleUrls: ['./lista-parametros-sistema-pais.component.css']
})
export class ListaParametrosSistemaPaisComponent implements OnInit {
