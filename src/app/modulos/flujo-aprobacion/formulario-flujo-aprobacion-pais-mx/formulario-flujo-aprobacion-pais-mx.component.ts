...
@Component({
  selector: 'app-formulario-flujo-aprobacion-pais-mx',
  templateUrl: './formulario-flujo-aprobacion-pais-mx.component.html',
  styleUrls: ['./formulario-flujo-aprobacion-pais-mx.component.css']
})
export class FormularioFlujoAprobacionPaisMxComponent implements OnInit {
  ...
  modo_flujo: { clave: string, valor: string };
  ...
  setModoFlujo() {
    this.modo_flujo = this.datos_inciales.funcionalidades.find(x => x.clave == 'MOD_FLUJO');
    console.log(this.modo_flujo);
  ...
  obtenerCatalogos(identificador_corporativo: any = null) {
    ...
    if (this.modo_flujo && this.modo_flujo.valor == 'mod_rci') {
  ...
  actualizarTipoDocumento(obj: any) {
  ...
  obtenerContribuyente() {
    this._servicios_compartidos.getAllContribuyentesCorporativo(this.identificador_corporativo).subscribe((data) => {
      this.lista_constribuyentes = $.map(data, function (obj: any) {
        obj.id = obj.identificador;
        obj.text = `${obj.codigo} - ${obj.nombre}`;
        return obj;
  ...
  obtenerSucursales() {
    this._servicios_compartidos.getAllSucursalesCorporativo(this.identificador_corporativo).subscribe((data) => {
      this.lista_sucursales = $.map(data, function (obj: any) {
        obj.id = obj.identificador;
        obj.text = `${obj.codigo} - ${obj.nombre}`;
        return obj;
  ...
  obtenerDepartamentos() {
    this._servicios_compartidos.getAllDepartamentosCorporativo(this.identificador_corporativo).subscribe((data) => {
      this.lista_despartamentos = $.map(data, function (obj: any) {
        obj.id = obj.identificador;
        obj.text = `${obj.clave_departamento} - ${obj.descripcion}`;
        return obj;
