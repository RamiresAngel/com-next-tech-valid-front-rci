...
@Component({
  selector: 'app-listar-cfdi-cs-mx',
  templateUrl: './listar-cfdi-cs-mx.component.html',
  styleUrls: ['./listar-cfdi-cs-mx.component.css']
})
export class ListarCfdiCsMxComponent implements AfterViewInit, OnInit, OnDestroy {
  listener: () => void;
  ...
  constructor(
    ...
    this.url = `${this.globals.host_documentos}/gasto/carga_factura_simple/list`;
  }
