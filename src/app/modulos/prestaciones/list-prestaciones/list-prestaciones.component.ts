...
@Component({
  selector: 'app-list-prestaciones',
  templateUrl: './list-prestaciones.component.html',
  styleUrls: ['./list-prestaciones.component.css']
})
export class ListPrestacionesComponent implements OnInit {
