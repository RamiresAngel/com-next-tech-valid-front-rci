...
@Component({
  selector: 'app-list-departamento-rci',
  templateUrl: './list-departamento-rci.component.html',
  styleUrls: ['./list-departamento-rci.component.css']
})
export class ListDepartamentoRciComponent implements OnInit {
