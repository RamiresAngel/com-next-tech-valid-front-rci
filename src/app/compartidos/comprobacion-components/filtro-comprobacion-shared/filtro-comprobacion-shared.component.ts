...
@Component({
  selector: 'app-filtro-comprobacion-shared',
  templateUrl: './filtro-comprobacion-shared.component.html',
  styleUrls: ['./filtro-comprobacion-shared.component.css']
})
export class FiltroComprobacionSharedComponent implements OnInit {
